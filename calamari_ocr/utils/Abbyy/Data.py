...
class Book:
    ...
    def __init__(self, ordnerpath: str, schemaLocation: str, version: float, producer: str, languages: str):

        """
        Constructs a book object with an empty page list
        :param ordnerpath: the directory where the documents of the book are stored
        """

        self.ordnerpath = ordnerpath
    ...
    def __str__(self):
        return 'Document:[ordnerpath=\''+self.ordnerpath+\
                '\', schemaLocation=\''+self.schemaLocation.__str__()+\
                '\', version=\''+self.version.__str__()+\
                '\', producer=\''+self.producer.__str__()+\
                '\', languages=\''+self.languages.__str__()+\
                '\']'
...
class Block:
    ...
    def __str__(self):
        return 'Block:[BlockType=\''+self.blockType+'\', '+self.rect.__str__()+']'
